...
#define DIAG_JUMPERS_REMOVED  // gets rid of warning about sensorless homing
...
#define STRING_CONFIG_H_AUTHOR "(Vesuvan, SKR MINI E3 V3)" // Who made the changes.
...
//
// May need to uncomment the following define    
/**
